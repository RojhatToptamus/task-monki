...
export const DEV_SEED_SCENARIOS: DevSeedScenarioDefinition[] = [
  ...
  scenario('discourse-abc-ready', 'discourse', 'Team comparison ready', 'Independent answers converge on a bounded migration decision.', ['discourse:team', 'status:COMPLETE']),
  scenario('discourse-abc-waiting', 'discourse', 'Team needs your decision', 'The comparison preserves a disagreement about the rollback window.', ['discourse:team', 'status:PARTIAL']),
  scenario('discourse-abc-responding', 'discourse', 'Team authors responding', 'An author corrects C while another response is still running.', ['discourse:team', 'status:RUNNING']),
  scenario('discourse-abc-failed', 'discourse', 'Team incomplete', 'One answer is preserved after the other author fails.', ['discourse:team', 'status:FAILED']),
  scenario('discourse-abc-stale', 'discourse', 'Team context changed', 'The comparison could not complete against unchanged context.', ['discourse:team', 'status:STALE']),
